...
import com.atompacman.configuana.TestConsoleApps.HasFlagWithNegNumArgs.NegNumArgs;
import com.atompacman.configuana.param.Param;

public class TestConsoleApps {
	...
	public static class DoesntHaveAnEmptyConstructor extends App {
		...
		public List<Class<? extends Param>> getParamsClasses() { return null; }
		public void init() {}
