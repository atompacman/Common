...
public final class EnumUtils {
    ...
    public static <T extends Enum<T>> T prev(T value) {
        checkArgument(value.ordinal() != 0, "Can't get previous enum value: ordinal == 0");
    ...
    public static <T extends Enum<T>> T next(T value) {
        ...
        checkArgument(value.ordinal()<values.length-1,"Can't get next enum value: ordinal == max");
